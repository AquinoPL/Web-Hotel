...
INSERT INTO Categoria (category_type, category_beds, category_descripcion, category_maxcapacity,category_image) VALUES
('Simple', 1, 'Amplia Habitación Personal con Todas las Comodidades', '1 Persona','img_category/simple.jpg'),
('Doble', 2, 'Habitación con Todas las Comodidades con Camas Simples', '2 Personas','img_category/doble.jpg'),
('Triple', 3, 'Amplia Habitación con Todas las Comodidades para un Grupo Pequeño', '3 Personas','img_category/triple.jpg'),
('Matrimonial', 1, 'Habitación para Parejas con todas las Comodidades', '2 Personas','img_category/matrimonial.jpg'),
('Familiar', 2, 'Amplia Habitación para uso Familiar', '4 Personas','img_category/familiar.jpg'),
('Suite', 3, 'Cómoda Habitación con 2 Cuartos y 1 Salon + Cocina', '6 Personas','img_category/suite.jpg'),
('Suite Deluxe', 5, 'Amplia Habitación ideal para Grupos Grandes con 3 Cuartos, Salon, Cocina y Balcón', '6 Personas','img_category/suite_deluxe.jpg');
...
INSERT INTO Productos (product_price, product_quantity, product_name, product_description, product_image) VALUES
 (30.00, 50, 'Cerveza Corona', 'Cerveza Helada de 240ml', 'img_bar/cervezacorona.jpg'),
 (15.00, 30, 'Pisco Sour', 'Coctel preparado con pisco, limon, huevo y angostura', 'img_bar/piscosour.jpg'),
 (4.00, 75, 'Coca Cola', 'Bebida gaseosa personal', 'img_bar/cocacola.jpg'),
 (3.00, 90, 'Agua Mineral', 'Botella personal de agua mineral', 'img_bar/aguamineral.jpg'),
 (8.00, 35, 'Café Americano', 'Café caliente tradicional', 'img_bar/cafeamericano.jpg'),
 (10.00, 20, 'Jugo de Naranja', 'Jugo natural sabor a naranja', 'img_bar/jugonaranja.jpg'),
 (3.50, 60, 'Chips', 'Papas fritas cortadas en rodajas', 'img_bar/chips.jpg'),
 (12.00, 50, 'Chicha Morada', 'Bebida tradicional peruana a base de maíz morado', 'img_bar/chichamorada.jpg'),
 (20.00, 40, 'Mojito', 'Cóctel refrescante con ron, menta, lima, y azúcar', 'img_bar/mojito.jpg'),
 (25.00, 15, 'Pisco 100%', 'Pisco peruano tradicional', 'img_bar/pisco100.jpg'),
 (7.00, 50, 'Tamarindo', 'Bebida refrescante de tamarindo', 'img_bar/tamarindo.jpg'),
 (5.00, 100, 'Fanta', 'Bebida gaseosa sabor a naranja', 'img_bar/fanta.jpg'),
 (18.00, 40, 'Cerveza Cusqueña', 'Cerveza premium de 330ml', 'img_bar/cervezacusquena.jpg'),
 (22.00, 60, 'Ron Botrán', 'Ron oscuro premium de Guatemala', 'img_bar/ronbotran.jpg'),
 (10.00, 30, 'Inca Kola', 'Bebida gaseosa peruana sabor original', 'img_bar/incakola.jpg'),
 (14.00, 45, 'Limonada Frozen', 'Limonada fría con hielo triturado', 'img_bar/limonadafrozen.jpg'),
 (2.50, 120, 'Galletas', 'Galletas de chocolate crujientes', 'img_bar/galletas.jpg');

 
INSERT INTO Menu_Comedor (food_name, food_availability, food_price, food_description, food_type) VALUES
 ('Desayuno Criollo', TRUE, 30, 'Pan con chicharrón de cerdo, acompañado de salsa criolla, café o mate y jugo de naranja', 'desayuno'),
 ('Desayuno con Pan con Queso', TRUE, 25, 'Pan con queso fresco, mantequilla, café o mate y jugo natural', 'desayuno'),
 ('Desayuno Tacneño', TRUE, 28, 'Pan con jamón del país, queso fresco, café o mate y jugo de piña', 'desayuno'),
 
 ('Lomo Saltado', TRUE, 55, 'Plato principal a base de carne de res, cebolla, tomate, papas fritas y arroz, sazonado con salsa de soya', 'almuerzo'),
 ('Ají de Gallina', TRUE, 60, 'Pechuga de pollo deshilachada en una salsa cremosa de ají amarillo, nuez y pan, acompañada de arroz y papas', 'almuerzo'),
 ('Ceviche', TRUE, 45, 'Pescado fresco marinado en jugo de limón, acompañado de cebolla roja, cilantro, ají amarillo, y servido con camote y choclo', 'almuerzo'),
 ('Pachamanca', TRUE, 80, 'Carne de cerdo, pollo y cordero cocidos con hierbas aromáticas en un horno de tierra, acompañados de papas y habas', 'almuerzo'),
 ('Pollo a la Brasa', TRUE, 40, 'Pollo marinado en especias peruanas, asado a la brasa, acompañado de papas fritas y ensalada', 'almuerzo'),
 ('Causa Limeña', TRUE, 35, 'Puré de papa amarilla, ají amarillo, relleno de atún o pollo, acompañado de palta y huevo duro', 'almuerzo'),
 ('Sancochado', TRUE, 70, 'Sopa espesa con carne de res, costillas, vegetales y tubérculos como papa, zanahoria y yuca', 'almuerzo'),
 ('Tacu Tacu con Seco de Res', TRUE, 65, 'Arroz y frejoles mezclados en una masa y acompañados de carne de res guisada con salsa de cilantro', 'almuerzo'),
 ('Tallarines Verdes con Bistec', TRUE, 50, 'Tallarines con salsa de albahaca, acompañados de un filete de carne de res', 'almuerzo'),
 ('Seco de Cabrito', TRUE, 75, 'Carne de cabrito guisada con cilantro, ají panca y cerveza, acompañada de arroz y frejoles', 'almuerzo'),
 ('Arroz con Pollo', TRUE, 50, 'Arroz cocido con cilantro y especias, acompañado de pollo a la brasa, ensalada y papas', 'almuerzo'),
 ('Cau Cau', TRUE, 40, 'Plato de mondongo con papas y salsa amarilla a base de ají amarillo, acompañada de arroz blanco', 'almuerzo'),
 ('Frejoles con Seco de Res', TRUE, 60, 'Frejoles guisados con carne de res en salsa de cilantro, acompañado de arroz', 'almuerzo'),
 ('Papa a la Huancaína', TRUE, 30, 'Papas hervidas cubiertas con una salsa de ají amarillo, queso fresco y leche, acompañadas de huevo duro y aceitunas', 'almuerzo'),
 ('Tamalito Verde', TRUE, 25, 'Tamal de maíz verde relleno con carne de cerdo o pollo, servido con salsa criolla', 'almuerzo'),
 
 ('Omelette de Espárragos', TRUE, 50, 'Omelette relleno de espárragos frescos, servido con papas fritas o arroz', 'cena'),
 ('Sopa Seca', TRUE, 55, 'Sopa espesa de fideos con hierbas peruanas, acompañada de carne de res o pollo', 'cena'),
 ('Pescado a la Parrilla', TRUE, 70, 'Pescado fresco a la parrilla, acompañado de arroz y ensalada', 'cena'),
 ('Chupe de Camarones', TRUE, 65, 'Sopa espesa a base de camarones, papas, choclo, y queso fresco', 'cena'),
 ('Tacu Tacu con Pescado', TRUE, 60, 'Tacu Tacu acompañado de filete de pescado a la plancha y ensalada fresca', 'cena'),
 ('Sopa de Pollo con Fideos', TRUE, 40, 'Sopa ligera de pollo con fideos, zanahoria, y apio', 'cena'),
 ('Almejas a la Chalaca', TRUE, 50, 'Almejas frescas servidas con cebolla, tomate, ají amarillo y limón', 'cena'),
 ('Pargo Frito con Yuca', TRUE, 75, 'Pargo frito acompañado de yuca frita y salsa criolla', 'cena'),
 ('Tortilla de Quinua', TRUE, 35, 'Tortilla de quinua con espinacas, acompañada de arroz o papas', 'cena'),
 ('Cordero al Palo', TRUE, 100, 'Cordero cocido lentamente en un asador, servido con papas y ensalada', 'cena');
...
('2024-10-15', '2024-12-17', 1, 1, 'Vacaciones familiares', TRUE, 2, 'completada'),
