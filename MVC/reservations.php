    ...
    <main>
        ...
        <section id="roomCatalog" class="room-catalog">
            ...
            <div class="room-grid">
                <?php
                $showRooms = false;
                $sql = "SELECT c.category_id, c.category_type, c.category_descripcion, h.room_price, c.category_image
                        FROM Habitaciones h 
                        INNER JOIN Categoria c ON h.category_id = c.category_id
                ...
                if ($showRooms) {
                    ...
                    if ($result->num_rows > 0) {
                        while ($row = $result->fetch_assoc()) {
                            $imagePath = $row['category_image'] ?: 'https://via.placeholder.com/300x200';
